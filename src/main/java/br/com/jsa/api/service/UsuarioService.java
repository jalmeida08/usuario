...
import br.com.jsa.dominio.usuario.UsuarioValidaPrimeiroAcessoBO;
...
public abstract class UsuarioService {
	...
	public void primeiroAcesso(
		...
		var u = getUsuarioPorId(idUsuario);
		
		UsuarioValidaPrimeiroAcessoBO
				.validaAcaoUsuarioAlteracao(u, chavePendenciaAlteracaoDados, form);
	...
	public List<UsuarioFuncionarioDTO> listaUsuario() {
		return usuarioRepository
				.findAll()
				.stream()
				.map(UsuarioFuncionarioDTO::new)
	...
	public Optional<UsuarioFuncionarioDTO> recuperaDadosUsuarioFuncionarioPorChaveAlteracaoDados(String chave) {
		var u = this.usuarioRepository
				.findByChavePendenciaAlteracaoDadoUsuario(chave);
		
		if(u.isEmpty())
			return Optional.empty();

		return Optional.of(new UsuarioFuncionarioDTO(u.get()));
	}
}
